...
public final class AComandoBlocoSimpleStatement extends PSimpleStatement
{
    private PBloco _bloco_;

    public AComandoBlocoSimpleStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AComandoBlocoSimpleStatement(
    ...
    {
        ((Analysis) sw).caseAComandoBlocoSimpleStatement(this);
    }
