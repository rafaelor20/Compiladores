...
public final class ASeSimplesOpenStatement extends POpenStatement
{
    private TSe _se_;
    ...
    public ASeSimplesOpenStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASeSimplesOpenStatement(
            cloneNode(this._se_),
    ...
    {
        ((Analysis) sw).caseASeSimplesOpenStatement(this);
    }
