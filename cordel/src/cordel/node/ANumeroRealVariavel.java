...
public final class ANumeroRealVariavel extends PVariavel
{
    private TNumeroReal _numeroReal_;

    public ANumeroRealVariavel()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANumeroRealVariavel(
    ...
    {
        ((Analysis) sw).caseANumeroRealVariavel(this);
    }
