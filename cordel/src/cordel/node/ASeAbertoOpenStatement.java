...
public final class ASeAbertoOpenStatement extends POpenStatement
{
    private TSe _se_;
    ...
    public Object clone()
    {
        return new ASeAbertoOpenStatement(
            cloneNode(this._se_),
    ...
    {
        ((Analysis) sw).caseASeAbertoOpenStatement(this);
    }
